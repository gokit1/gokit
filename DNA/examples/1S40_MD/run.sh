...
echo "======================================================="
echo "nat_DNA_nat_contacts: 1S40.pdb as input pdb. Using different parameters for Protein-DNA interface."
...
cp Output/Charged_Aromatic/nat_DNA_nat_contacts/1S40.pdb .
cp Output/Charged_Aromatic/nat_DNA_nat_contacts/run.sh .
mv Output/Charged_Aromatic/nat_DNA_nat_contacts/polyT.pdb .
mv Output/Charged_Aromatic/nat_DNA_nat_contacts/1S40_DNA.pdb .
fi

echo "======================================================="
echo "nonat_DNA_nonat_contacts: 1S40.pdb as input pdb. Using different DNA structure along with different parameters for Protein-DNA interface."
echo "In the case an interface file is used: nucpro_interface.input. Thefile is used for providing custom repulsion term when accounting for DNA-Protein interaction"
...
cp Output/Charged_Aromatic/nonat_DNA_nonat_contacts/1S40.pdb .
...
mv Output/Charged_Aromatic/nonat_DNA_nonat_contacts/1S40_DNA.pdb .
fi

echo "======================================================="
echo "nat_DNA_nonat_contacts: 1S40.pdb as input pdb. Using native DNA sequecne structure as custom input (no notive contacts) along with different parameters for Protein-DNA interface."
echo "In the case an interface file is used: nucpro_interface.input. Thefile is used for providing custom repulsion term when accounting for DNA-Protein interaction"
...
cp Output/Charged_Aromatic/nat_DNA_nonat_contacts/1S40.pdb .
cp Output/Charged_Aromatic/nat_DNA_nonat_contacts/1S40_DNA.pdb .
cp Output/Charged_Aromatic/nat_DNA_nonat_contacts/run.sh .
mv Output/Charged_Aromatic/nat_DNA_nonat_contacts/polyT.pdb .
mv Output/Charged_Aromatic/nat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Charged/nat_DNA_nat_contacts/1S40.pdb .
cp Output/Charged/nat_DNA_nat_contacts/run.sh .
mv Output/Charged/nat_DNA_nat_contacts/polyT.pdb .
mv Output/Charged/nat_DNA_nat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Charged/nonat_DNA_nonat_contacts/1S40.pdb .
...
mv Output/Charged/nonat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Charged/nat_DNA_nonat_contacts/1S40.pdb .
cp Output/Charged/nat_DNA_nonat_contacts/1S40_DNA.pdb .
cp Output/Charged/nat_DNA_nonat_contacts/run.sh .
mv Output/Charged/nat_DNA_nonat_contacts/polyT.pdb .
mv Output/Charged/nat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
python ../../nucproSBM.py --aa_pd 1S40.pdb --grotop gromacs.top -pdbgro gromacs.gro  --CA_rad 1.9 --skip_glycine  --CBfar --no_Pcharge --dielec 70 --iconc 0.01 --CB_rad 1.5 --debye --interface #--custom_nuc polyT.pdb
...
cp Output/Aromatic/nat_DNA_nat_contacts/1S40.pdb .
cp Output/Aromatic/nat_DNA_nat_contacts/run.sh .
mv Output/Aromatic/nat_DNA_nat_contacts/polyT.pdb .
mv Output/Aromatic/nat_DNA_nat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Aromatic/nonat_DNA_nonat_contacts/1S40.pdb .
...
mv Output/Aromatic/nonat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
python ../../nucproSBM.py --aa_pd 1S40.pdb --grotop gromacs.top -pdbgro gromacs.gro  --CA_rad 1.9 --skip_glycine  --CBfar --no_Pcharge  --dielec 70 --iconc 0.01 --CB_rad 1.5 --debye --interface --custom_nuc 1S40_DNA.pdb
...
cp Output/Aromatic/nat_DNA_nonat_contacts/1S40.pdb .
cp Output/Aromatic/nat_DNA_nonat_contacts/1S40_DNA.pdb .
cp Output/Aromatic/nat_DNA_nonat_contacts/run.sh .
mv Output/Aromatic/nat_DNA_nonat_contacts/polyT.pdb .
mv Output/Aromatic/nat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Blank_control/nat_DNA_nat_contacts/1S40.pdb .
cp Output/Blank_control/nat_DNA_nat_contacts/run.sh .
mv Output/Blank_control/nat_DNA_nat_contacts/polyT.pdb .
mv Output/Blank_control/nat_DNA_nat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Blank_control/nonat_DNA_nonat_contacts/1S40.pdb .
...
mv Output/Blank_control/nonat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
...
cp Output/Blank_control/nat_DNA_nonat_contacts/1S40.pdb .
cp Output/Blank_control/nat_DNA_nonat_contacts/1S40_DNA.pdb .
cp Output/Blank_control/nat_DNA_nonat_contacts/run.sh .
mv Output/Blank_control/nat_DNA_nonat_contacts/polyT.pdb .
mv Output/Blank_control/nat_DNA_nonat_contacts/1S40_DNA.pdb .
fi
